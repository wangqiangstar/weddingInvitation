<template>
    <div class="map">
        ...
        <map class="content" id="map" :longitude="longitude" :latitude="latitude" show-location="true" :markers="markers" :scale="scale" @tap="toNav" @markertap="toNav" @callouttap="toNav"></map>
        <div class="call">
...
export default {
  ...
  methods: {
    ...
    linkHe () {
      wx.makePhoneCall({
        phoneNumber: '15638996815'
      })
    },

    linkShe () {
      wx.makePhoneCall({
        phoneNumber: '13781761739'
      })
    }
  }
}
